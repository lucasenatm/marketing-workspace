...
### Se os arquivos de contexto existem e estão configurados
...
Se houver tarefas pendentes em `tarefas.md`, mencione até 3 itens antes do resumo.

### Se os arquivos de contexto não existem ou estão vazios
